...
function App() {
  return (
    ...
    >
      ...
      />
      <Resource name="referral" options={{ label: "Referral", menuParent: "settingss" }} edit={Referral} />
      <Resource name="banner" list={BannerList} create={BannerCreate} />
      <Resource name="notification" list={NotifList} create={NotifCreate} edit={NotifEdit} />
    </Admin>
  );
}
