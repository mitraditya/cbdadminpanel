...
import { Edit, SimpleForm, TextInput, NumberInput, AutocompleteInput } from "react-admin";
  ...
  return (
    <Edit title="Edit a Missing Claim" {...props}>
        <SimpleForm>
            ...
            <TextInput source='click_id' label='Click' />
            <TextInput source='store_id' label='Store' />
            <TextInput source='network_id' label='Network' />
